...
public class MsgResult extends HashMap<String, Object> {
    ...
    /**
     * 初始化一个新创建的 MsgResult 对象，使其表示一个空消息。
     */
    public MsgResult() {
    }

    /**
     * 初始化一个新创建的 MsgResult 对象
     *
     * @param code 状态码
     * @param msg  返回内容
     */
    ...
    public static MsgResult success(String msg) {
        return MsgResult.success(msg, null);
    }
    ...
    public static MsgResult success(String msg, Object data) {
        return new MsgResult(HttpStatus.SUCCESS, msg, data);
    }
    ...
    public static MsgResult error(String msg) {
        return MsgResult.error(msg, null);
    }
     ...
     * @return 警告消息
     */
    public static MsgResult error(String msg, Object data) {
        return new MsgResult(HttpStatus.ERROR, msg, data);
    }
    ...
    public static MsgResult error(int code, String msg) {
        return new MsgResult(code, msg, null);
    }
}
